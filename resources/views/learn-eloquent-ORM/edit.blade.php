            ...
            <div class="col-md-10 shadow p-4">
                ...
                <form action="{{route('division.update',$division->id)}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{  $division->division_name }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="usercode" id="usercode" class="form-control" value="{{  $division->class_id  }}">
                        @error('usercode')
                            <span class="text-danger text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="totalstudent" id="totalstudent" class="form-control" value="{{  $division->total_student  }}">
                        @error('totalstudent')
                            <span class="text-danger text-sm">{{ $message }}</span>
                        @enderror
                    </div>
